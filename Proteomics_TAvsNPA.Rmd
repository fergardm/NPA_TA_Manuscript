...
# Remove duplicate rows based on Protein.IDs:
...
c.shared <- venndetail(list(NPA=r.tabl.all.NPA$term_id, TA=r.tabl.all.TA$term_id))
c.shared.res <- result(c.shared)
shared.ids <- c.shared.res$Detail[c.shared.res$Subset=="Shared"]
